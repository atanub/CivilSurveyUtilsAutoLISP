...
GetCSData : dialog 
{
   ...
   : boxed_row {
		label = "Exaggeration";
		: edit_box { label = "Horz.:"; key = "HorSca"; alignment = left; mnemonic  = "M"; fixed_width = true;}
		: edit_box { label = "Vert.:"; key = "VerSca"; alignment = left; mnemonic  = "X"; fixed_width = true;}
   }
   : edit_box { label = "Datum Level in Metre :"; key = "DatumLevel"; alignment = left; mnemonic  = "D"; fixed_width = true;}
   : row {
	   : column {
	     : boxed_row {
		   label = "Draw Stations";
   ...
   : row {
	   : boxed_row {
		   ...
		   : column {
			 ...
			 : text { label = "Label Row Height :"; alignment = left; mnemonic  = "M"; fixed_width = true;}
		   }
		   : column {
			 ...
			 : edit_box { key = "RowHeight"; alignment = left; mnemonic  = "R"; fixed_width = true;}
		   }
	   }
	   : boxed_row{
   ...
   : row {
	   : boxed_row {
		   ...
		   : column {
			 ...
			 : edit_box { key = "LabelAnnSize"; alignment = left; mnemonic  = "K";}
			 : edit_box { key = "StnAnnSize"; alignment = left; mnemonic  = "S";}
			 : edit_box { key = "RowHeight"; width = 10; alignment = left; mnemonic  = "M"; fixed_width = true;}
		   }
	   }
	   : boxed_row{
		 label = "Annotation Labels for";
...
// Insert Points =========================================================
//
GetXPortSPointsData : dialog
{
   label = "Export Survey Points";
   : row
   {
     : button { label = "Select Data File..."; mnemonic  = "S"; key = "FileButt";}
     : edit_box { key = "FileEBox"; width = 16;}
...
GetCSDataMFC : dialog 
{
   ...
   : row {
	   : boxed_row {
			label = "Exaggeration";
			 : edit_box { label = "Horizontal:"; key = "HorSca"; alignment = left; mnemonic  = "O"; fixed_width = true;}
			 : edit_box { label = "Vertical :"; key = "VerSca"; alignment = left; mnemonic  = "t"; fixed_width = true;}
 	   }
  }
  : row {
	   : column {
		   : boxed_column {
				 ...
				 : edit_box { label = "Horizontal:"; key = "VerGrphNo"; alignment = left; mnemonic  = "H";}
				 : edit_box { label = "Vertical :"; key = "HorGrphNo"; alignment = left; mnemonic  = "V";}
		   }
	     : edit_box { label = "Datum (Metre):"; key = "DatumLevel"; alignment = left; mnemonic  = "D";}
	     : button { label = "Annotation..."; key = "AnnTextButt"; mnemonic  = "A";}
	   }
	   : boxed_column {
		   label = "Start Point";
	   ...
	   : column {
		   : boxed_row {
			   ...
			   : column {
				 ...
				 : text { label = "Labels:"; alignment = left; fixed_width = true;}
				 : text { label = "Station Labels:"; alignment = left; fixed_width = true;}
				 : text { label = "Row Height :"; alignment = left; fixed_width = true;}
				 : spacer {height = 1;}
			   }
			   : column {
				 : edit_box { key = "NumAnnSize"; alignment = left; mnemonic  = "N";}
				 ...
				 : edit_box { key = "StnAnnSize"; alignment = left; mnemonic  = "S";}
				 : edit_box { key = "RowHeight"; alignment = left; mnemonic  = "R";}
				 : spacer {height = 1;}
			   }
		   }
		}
...
//
//
GetQProfileData : dialog 
{
   label = "Quick Profile Data";
   : row
   {
	   : boxed_row
	   {
			label = "Exaggeration";
			: edit_box { label = "Horz.:"; key = "HorSca"; alignment = left; mnemonic  = "D"; fixed_width = true;}
			: edit_box { label = "Vert.:"; key = "VerSca"; alignment = left; mnemonic  = "X"; fixed_width = true;}
	   }
	   : boxed_row
	   {
			label = "Elevation";
			: edit_box { label = "Datum :"; key = "Datum"; alignment = left; mnemonic  = "D"; fixed_width = true;}
	   }
  }
   : boxed_row
   {
		label = "Annotation";
		: edit_box { label = "Numeric :"; key = "NumAnnSize"; alignment = left; mnemonic  = "N"; fixed_width = true;}
		: edit_box { label = "Row Label:"; key = "RowAnnSize"; alignment = left; mnemonic  = "L"; fixed_width = true;}
		: edit_box { label = "Row Height:"; key = "RowHt"; alignment = left; mnemonic  = "R"; fixed_width = true;}
   }
   : row
   {
		: boxed_row
		{
			...
			: column
			{
				 : text { label = "Elevation:"; alignment = left; fixed_width = true;}
				 : text { label = "Northing:"; alignment = left; fixed_width = true;}
				 : text { label = "Easting:"; alignment = left; fixed_width = true;}
				 : text { label = "Cumulative Distance :"; alignment = left; fixed_width = true;}
				 : text { label = "Distance:"; alignment = left; fixed_width = true;}
				 : text { label = "Datum :"; alignment = left; fixed_width = true;}
			}
			: column
			{
				: edit_box { key = "ElevTag"; alignment = left; mnemonic  = "E";  width = 20;}
				: edit_box { key = "NorthingTag"; alignment = left; mnemonic  = "N";  width = 20;}
				: edit_box { key = "EastingTag"; alignment = left; mnemonic  = "t";  width = 20;}
				: edit_box { key = "CumDistTag"; alignment = left; mnemonic  = "C";  width = 20;}
				: edit_box { key = "DistTag"; alignment = left; mnemonic  = "D";  width = 20;}
 				: edit_box { key = "DatumTag"; alignment = left; mnemonic  = "D";  width = 20;}
			}
		}
		: column
		{
		   : edit_box { label = "Layer :"; key = "Layer"; alignment = left; mnemonic  = "L";  fixed_width = true;}
		   : boxed_column {
			   label = "Start Point";
			   : edit_box { label = "X:"; key = "OrdX"; width = 2; alignment = left; mnemonic  = "X"; }
			   : edit_box { label = "Y:"; key = "OrdY"; width = 2; alignment = left; mnemonic  = "Y"; }
			   : edit_box { label = "Z:"; key = "OrdZ"; width = 2; alignment = left; mnemonic  = "Z"; }
			   : button { label = "Point <"; key = "PointButt"; mnemonic  = "P";}
		   }
		}
  }
...
GetRoadPflNEZData : dialog 
{
   label = "Quick Road Profile Data";
   : row
   {
		: list_box { label = "Selected Points"; key = "list"; tabs  = "10"; width = 70;}
		: column
		{
			 : spacer {height = 10;}
			 : button { label = "Add >"; key = "add"; width = 10; mnemonic  = "A";}
			 : button { label = "Delete"; key = "del"; width = 10; mnemonic  = "D";}
		}
  }
  : row {
     : spacer {width = 1;}
